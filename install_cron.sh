...
echo ""
echo "5️⃣  URL directa para buscar TODOS los partidos con pronósticos y validarlos:"
echo "    https://TU-DOMINIO/validate_predictions_now.php?secret=$SECRET_KEY"
echo ""
echo "6️⃣  Para cambiar la frecuencia, edita con:"
echo "    crontab -e -u $WEB_USER"
echo ""
echo "7️⃣  Para verificar que está activo:"
echo "    crontab -l -u $WEB_USER | grep cron_verify"
echo ""
echo "8️⃣  Para ver logs (si los hay):"
echo "    tail -f /var/log/syslog | grep CRON"
echo ""
echo "9️⃣  Cambios en api.php:"
